...
public class Constants {
    ...
    public static final String userdata = "api/users";
    public static final String asistencia = "api/faceasistencias";
    public static final String imagenes = "api/imagenes";
}
